...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-3.44.4-I-2001-Mail-Update-preview-s-iframe-height-to-match-.patch
	eapply "${FILESDIR}"/${PN}-3.44.4-I-1969-EShellWindow-The-New-menu-is-not-filled-after.patch
}
